export const ROOT_HELP = [
  "AgentsHub CLI",
  "",
  "用于直接读写 AgentsHub 本地数据库与技能仓库。默认输出 JSON；如需更易读的输出可加 `--output table`。",
  "",
  "用法:",
  ...
  "",
  "全局参数:",
  "  --data-dir <dir>        指定 AgentsHub userData 目录",
...
export const SKILL_HELP = [
  ...
  "",
  "delete/remove 语义:",
  "  默认会删除 AgentsHub 中的 skill 记录，并尝试从已支持平台卸载 SKILL.md。",
  "  不会默认删除本地源码目录；若目标 repo 位于 AgentsHub 管理目录内，可额外加 --purge-managed-repo。",
  "",
  "删除参数:",
  "  --keep-platform-installs  不从 Claude/Cursor 等平台卸载",
  "  --purge-managed-repo      同时删除 AgentsHub 管理目录中的本地 repo",
  "",
  "安装参数:",
...
export const MCP_HELP = [
  ...
  "",
  "说明:",
  "  MCP CLI 读写与桌面端相同的 AgentsHub MCP library。",
